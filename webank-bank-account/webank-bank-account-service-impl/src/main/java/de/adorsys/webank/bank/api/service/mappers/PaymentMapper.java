...
public interface PaymentMapper {
    ...
    @Mapping(target = "bankTransactionCode", expression = "java(de.adorsys.webank.bank.api.domain.BankTransactionCode.getByPaymentProduct(paymentTarget.getPayment().getPaymentProduct()))")
    @Mapping(target = "proprietaryBankTransactionCode", expression = "java(de.adorsys.webank.bank.api.domain.BankTransactionCode.getByPaymentProduct(paymentTarget.getPayment().getPaymentProduct()))")
    ...
    @Mapping(target = "proprietaryBankTransactionCode", expression = "java(de.adorsys.webank.bank.api.domain.BankTransactionCode.getByPaymentProduct(payment.getPaymentProduct()))")
    @Mapping(target = "bankTransactionCode", expression = "java(de.adorsys.webank.bank.api.domain.BankTransactionCode.getByPaymentProduct(payment.getPaymentProduct()))")
