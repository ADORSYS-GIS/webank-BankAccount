...
public interface PaymentMapper {
    ...
    @Mapping(target = "bankTransactionCode", expression = "java(de.adorsys.ledgers.bank.api.domain.BankTransactionCode.getByPaymentProduct(paymentTarget.getPayment().getPaymentProduct()))")
    @Mapping(target = "proprietaryBankTransactionCode", expression = "java(de.adorsys.ledgers.bank.api.domain.BankTransactionCode.getByPaymentProduct(paymentTarget.getPayment().getPaymentProduct()))")
    ...
    @Mapping(target = "proprietaryBankTransactionCode", expression = "java(de.adorsys.ledgers.bank.api.domain.BankTransactionCode.getByPaymentProduct(payment.getPaymentProduct()))")
    @Mapping(target = "bankTransactionCode", expression = "java(de.adorsys.ledgers.bank.api.domain.BankTransactionCode.getByPaymentProduct(payment.getPaymentProduct()))")
    ...
    @Mapping(target = "debtorName", source = "BankAccount.name")
    @Mapping(target = "debtorAccount", source = "BankAccount.reference")
    @Mapping(target = "creditorName", source = "BankAccount.name")
    ...
    TransactionDetailsBO toDepositTransactionDetails(AmountBO amount, BankAccountBO BankAccount, AccountReferenceBO creditorAccount, LocalDate postingDate, String postingLineId, BalanceBO balanceAfterTransaction, ObjectMapper objectMapper);
