...
import de.adorsys.ledgers.bank.api.service.BankAccountTransactionService;
...
import de.adorsys.ledgers.bank.db.repository.PaymentRepository;
...
import static de.adorsys.ledgers.bank.api.domain.ExecutionRules.FOLLOWING;
import static de.adorsys.ledgers.bank.api.domain.ExecutionRules.PRECEDING;
...
public class PaymentExecutionService implements InitializingBean {
    ...
    private final BankAccountTransactionService txService;
